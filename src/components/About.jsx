...
const ServiceCard = ({ index, title, icon }) => (
  <Tilt className="xs:w-[250px] w-full">
    <motion.div
      variants={fadeIn("right", "tween", (services.length - index) * 0.4, 0.4)}
...
const About = () => {
  return (
    <>
      ...
      <motion.p
        variants={fadeIn("", "", 0.6, 0.75)}
        className="mt-4 text-secondary text-[17px] max-w-3xl leading-[30px]"
      >
        I'm a tech-savvy explorer with a passion for innovation and a
        hunger for knowledge—a software engineer ready to embark on exciting
        coding adventures. With a knack for problem-solving, a love for
